...
CHECKPOINTS = [
    {"name": "BERT-Base", "quant": "E8", "dir": "qat_bert_base_e8_v4",
     "out": "bert_base_e8_quant.bin", "rows": 768, "cols": 768},
    {"name": "BERT-Base", "quant": "Z8", "dir": "qat_bert_base_z8_v4",
     "out": "bert_base_z8_quant.bin", "rows": 768, "cols": 768},
    {"name": "TinyBERT",  "quant": "E8", "dir": "qat_tinybert_e8_v4",
     "out": "tinybert_e8_quant.bin",   "rows": 312, "cols": 312},
    {"name": "TinyBERT",  "quant": "Z8", "dir": "qat_tinybert_z8_v4",
    ...
    for name, tensor in sd.items():
        ...
        if name in qat_names:
            assert arr.size % BLOCK_SIZE == 0, (
                f"{name} has {arr.size} elements, not a multiple of 32"
            )
