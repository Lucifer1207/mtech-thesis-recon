...
def run_qat(model_name, model_source, codebook, quant_type,
            ...
            device, epochs=5, lr=2e-5, batch_size=16):
    ...
    save_dir = f"qat_{model_name.replace('-','_').lower()}_{quant_type.lower()}_v5"
...
# ═══════════════════════════════════════════════════════════
# SECTION 4b: ERROR-VS-EPOCH GRAPHING
# ═══════════════════════════════════════════════════════════
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Run QAT with variable epochs.")
    parser.add_argument("--epochs", type=int, default=3, help="Number of training epochs (default: 3)")
    args = parser.parse_args()

    EPOCHS_USED = args.epochs
    print(f" Running QAT script for {EPOCHS_USED} epochs.")
